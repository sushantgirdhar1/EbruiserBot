...
__help__ = f"""
Read Help of AntiSpam Module Before,then Read this.
*Available Admin only Command:* 
...
Note: If Mistakenly Gbanned or want to report someone for gban , appeal here {SUPPORT_CHAT}
"""
